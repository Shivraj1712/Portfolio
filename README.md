...
* **Key Architecture:** Uses a Go web server that talks to a PostgreSQL database to store spending entries and handles secure logins.
...
## 💎 Portfolio Infrastructure & Redesign Features

* **Custom UI Primitives**: Built with clean, custom layouts including a Floating Nav bar, typing text changes, hover effects, and interactive code matrix cards.
* **Simple Page Navigation**: Smooth scroll links across sections with a timeline progress line.
* **Simulated Logs Console**: A terminal simulation displaying actual database and router queries.
* **Modern Style**: Styled with a dark glass theme, neon highlights, and custom layouts in elegant cursive handwriting fonts.
...
* **Backend Engineering:** Learning interface design, container tools like Docker, and memory caching.
* **Data Structures & Algorithms:** Improving skills in sorting, search, graphs, and code speed optimization.
* **Database Safety:** Structuring secure database operations with automatic error recovery.
...
- **WhatsApp:** [Chat on WhatsApp](https://wa.me/916355540489)