...
const Projects: React.FC = () => {
    return (
        <section id='projects' className='max-w-7xl mx-auto px-6 py-16 flex flex-col gap-10'>
            <div className='border-b border-border/60 pb-4'>
                <p className='font-mono text-sm text-accent tracking-widest'>03 // SELECTED_WORKS</p>
            </div>

            <div className='flex flex-col gap-12'>
                <div className='bg-card/30 border border-border rounded-xl overflow-hidden flex flex-col md:flex-row h-auto md:h-80 hover:border-accent/30 transition-colors duration-300'>
                    <div className='p-8 flex flex-col justify-between flex-grow md:w-3/5 gap-6'>
                        <div className='flex flex-col gap-4'>
                            ...
                            <h3 className='text-3xl font-black font-heading text-foreground tracking-tight'>StockPulse Engine</h3>
                    ...
                    <div className='bg-card/50 border-t md:border-t-0 md:border-l border-border/40 md:w-2/5 flex items-center justify-center p-8 min-h-[180px] md:min-h-0'>
                        <div className='flex items-end gap-3 h-24 w-56'>
                ...
                <div className='bg-card/30 border border-border rounded-xl overflow-hidden flex flex-col-reverse md:flex-row h-auto md:h-80 hover:border-accent/30 transition-colors duration-300'>
                    <div className='bg-card/50 border-b md:border-b-0 md:border-r border-border/40 md:w-2/5 flex items-center justify-center p-8 min-h-[180px] md:min-h-0 relative'>
                        <div className='border border-dashed border-accent/30 rounded-lg p-6 flex flex-col items-center justify-center gap-2 w-56 text-xs font-mono text-accent/60'>
                            <svg className="w-10 h-10 text-accent/80 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div className='p-8 flex flex-col justify-between flex-grow md:w-3/5 gap-6'>
                        <div className='flex flex-col gap-4'>
                            ...
                            <h3 className='text-3xl font-black font-heading text-foreground tracking-tight'>SpendGrid Ledger</h3>
                            <p className='text-base text-muted max-w-xl leading-relaxed'>
                ...
                <div className='bg-card/30 border border-border rounded-xl overflow-hidden flex flex-col md:flex-row h-auto md:h-80 hover:border-accent/30 transition-colors duration-300'>
                    <div className='p-8 flex flex-col justify-between flex-grow md:w-3/5 gap-6'>
                        <div className='flex flex-col gap-4'>
                            ...
                            <h3 className='text-3xl font-black font-heading text-foreground tracking-tight'>Noteitdown System</h3>
                            <p className='text-base text-muted max-w-xl leading-relaxed'>
                    ...
                    <div className='bg-card/50 border-t md:border-t-0 md:border-l border-border/40 md:w-2/5 flex items-center justify-center relative min-h-[180px] md:min-h-0 select-none'>
                        <span className='text-7xl md:text-8xl font-black text-muted/5 font-mono tracking-tighter'>ND</span>
                        <span className='absolute bottom-4 right-4 font-mono text-[10px] text-muted/40'>VERSION_1.0.0</span>
                    </div>
                </div>
            </div>
        </section>
